# Master Task - Perennial Signup Birth Location Field + Autocomplete (Planning Only) - 2026-04-09

- Status: Planned
- Priority: P0
- Owner: Frontend + API
- Scope: add `birth_location` to signup forms, autocomplete integration, payload mapping, validation, QA
- Task File: `tasks/perennial/2026-04-09/13-master-task-signup-birth-location-autocomplete-2026-04-09.md`

## Objective

Define the implementation plan to add `birth_location` input on Perennial signup and make it autocomplete-based.

## Requirements

1. Field must exist in signup form (Single/Couple/Family members where birth data is captured).
...
3. Selected option must persist:
   ...
   - `birth_lng`
   - `birth_tzone`
4. Validate selection before allowing signup progression.
...
1. Birth location appears in signup form.
