...
CREATE INDEX weekly_sub_diviner_idx ON weekly_subscription_products(diviner_id);
...
CREATE INDEX weekly_sub_product_idx ON weekly_subscription_subscribers(product_id, status);
CREATE INDEX weekly_sub_diviner_idx ON weekly_subscription_subscribers(diviner_id, status);
CREATE INDEX weekly_sub_email_idx ON weekly_subscription_subscribers(email);
...
CREATE INDEX weekly_delivery_product_idx ON weekly_subscription_deliveries(product_id, scheduled_for DESC);
