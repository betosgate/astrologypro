...
--    We have to drop-and-recreate because Postgres doesn't support ALTER on
--    a CHECK's body. Existing rows are untouched — all existing values
--    ('scheduled_dialin', 'standalone') remain valid under the new constraint.
DO $$
DECLARE
