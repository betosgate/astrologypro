        ...
        <main className="flex-1">
            ...
            <div className="relative mx-auto max-w-4xl px-4 text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-[#f5f0e8] sm:text-5xl lg:text-6xl">
                ...
                <span className="bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #f8d275 0%, #c9a84c 50%, #a07838 100%)" }}>
                  Nuance for Complex Questions
                </span>
              </h1>
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[#b8bcd0]/75">
                Some questions have more moving parts than a 3-card spread can hold. The 5-card spread
                adds context, influences, and deeper nuance — making it the ideal format for situations
                that require a fuller picture.
              </p>
              <div className="mt-10 flex flex-wrap items-center justify-center gap-10">
                <div className="text-center">
                  <p className="text-3xl font-bold text-[#c9a84c]">5 Cards</p>
                  <p className="mt-1 text-sm text-[#b8bcd0]/50">Layered Question Analysis</p>
                </div>
                <div className="h-10 w-px bg-white/10" aria-hidden="true" />
                <div className="text-center">
                  <p className="text-3xl font-bold text-[#c9a84c]">30 Minutes</p>
                  <p className="mt-1 text-sm text-[#b8bcd0]/50">Context + Guidance + Outcome</p>
                </div>
              </div>
              <div className="mt-10">
          ...
          <section className="px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl">
              <div className="grid items-center gap-12 md:grid-cols-2">
                <div>
                  <h2 className="text-2xl font-bold text-[#f5f0e8] sm:text-3xl">What Is a 5-Card Tarot Reading?</h2>
                  <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-[#b8bcd0]/70">
                    <p>
                      The 5-card spread builds on the foundation of the 3-card format by adding two
                      critical layers: the context (what influences are at play beneath the surface) and
                      the advice card (the recommended approach). This makes it the optimal format for
                      questions that are more complex than &lsquo;what will happen&rsquo; — for situations
                      involving relationships, career decisions, or multi-factor choices.
                    </p>
                    <p>
                      A common 5-card layout places cards in a cross or linear sequence: the central
                      situation, the crossing factor (what&rsquo;s complicating or opposing), the root
                      cause or past influence, the future trajectory, and the key advice. Variations
                      exist, but the core principle is the same: more positions allow more of the
                      situation&rsquo;s texture to surface.
                    </p>
                    <p>
                      Where the 3-card reading is surgical, the 5-card reading is panoramic — it shows
                      you the landscape of a situation from multiple angles simultaneously. For decisions
                      with significant consequences or interpersonal situations with several actors, the
                      5-card spread provides the depth of context that one-liner answers cannot.
                    </p>
                  </div>
                </div>
                <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-7">
                  <h3 className="mb-5 text-sm font-semibold uppercase tracking-widest text-[#c9a84c]">What a 5-Card Reading Reveals</h3>
          ...
          <section className="px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl">
              ...
              <p className="mb-10 text-center text-sm text-[#b8bcd0]/50">A 5-card tarot reading maps the full landscape of your situation</p>
              <div className="grid gap-6 sm:grid-cols-3">
                {[
                  { icon: "🃏", title: "Multi-Dimensional Layout", desc: "Your reader draws five cards and places them in a deliberate layout, each position adding a new layer of context to your question. You'll see the full architecture of the situation rather than just its most visible surface." },
                  { icon: "🔄", title: "Interconnected Interpretation", desc: "A skilled 5-card reading isn't five separate card meanings — it's one continuous story told across five positions. Your reader weaves the cards together into a coherent narrative that makes sense of the full situation." },
                  { icon: "🧭", title: "Actionable Guidance", desc: "The reading closes with clear, practical guidance based on the full spread — not just what will likely happen but what you can do to navigate the situation most effectively given the cards' collective message." },
                ].map((card) => (
          ...
          <section id="diviners" className="scroll-mt-20 px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl">
              <h2 className="mb-2 text-center text-2xl font-bold text-[#f5f0e8] sm:text-3xl">Find Your Tarot Reader</h2>
              <p className="mb-10 text-center text-sm text-[#b8bcd0]/50">These readers specialize in complex question spreads and multi-factor situations</p>
              {diviners.length > 0 ? (
          ...
          <section className="px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="space-y-3">
                {[
                  { q: "When should I choose a 5-card reading over a 3-card reading?", a: "Choose 5-card when your question involves multiple people or factors, when a simple yes/no or past/present/future doesn't capture enough of the situation's texture, or when you want both an outcome prediction AND specific advice on how to act. Relationship decisions, career crossroads, and complex family situations often benefit from the extra positions." },
                  { q: "What kinds of questions work best for a 5-card spread?", a: "Questions with context and multiple contributing factors: 'Why is this relationship not progressing?', 'Should I take this business risk?', 'What's really going on with this situation and what should I do about it?' The more nuance the situation holds, the more valuable the additional positions become." },
                  { q: "How is the advice card determined?", a: "In most 5-card layouts, one specific position is designated as the advice position from the start — before any cards are drawn. The card drawn for that position is interpreted as the most relevant guidance the spread is offering for the question, shaped by what the other four cards have revealed about the situation." },
                  { q: "Can I ask about another person in a 5-card reading?", a: "Yes — and the 5-card format is particularly good for this. One position can represent the other person's perspective or energy, another the dynamic between you, and the remaining positions the trajectory and guidance. Your reader can adjust the layout to hold the interpersonal complexity." },
                  { q: "Is a 5-card reading suitable for yes/no questions?", a: "It can certainly answer yes/no questions, but it's somewhat overpowered for them — a 3-card spread is more efficient for binary questions. The 5-card spread is best used when you want to understand the why, the how, and the nuance behind an outcome, not just the outcome itself." },
                ].map((item) => (
          ...
          <section className="px-4 py-16 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-[#c9a84c]/10 bg-[radial-gradient(ellipse_at_50%_50%,rgba(201,168,76,0.06)_0%,transparent_70%)] p-10 text-center md:p-14">
              <h2 className="text-2xl font-bold text-[#f5f0e8] sm:text-3xl">Ready for a reading that holds your question&apos;s full complexity?</h2>
              <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-[#b8bcd0]/65">
                Connect with a skilled tarot reader who can use the 5-card spread to map every layer of
                your situation — from root cause to advice to outcome — in a single, cohesive reading.
              </p>
              <div className="mt-8">
