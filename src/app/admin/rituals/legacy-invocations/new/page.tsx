...
/**
 * Legacy CRUD form for creating a `ritual_invocations` row. Preserved
 * because runtime community ritual rendering still reads this table
 * via /api/community/rituals/[id]. New ritual *definitions* should be
 * created via the Ritual Configurations module at /admin/rituals.
 */
export default function NewLegacyRitualPage() {
