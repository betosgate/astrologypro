      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Loading testimonial data…</p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Edit Testimonial</h1>
          <p className="text-muted-foreground text-sm">Update the properties and media for this testimonial.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update the feedback and rating from the customer.</CardDescription>
          </CardHeader>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
          <Button
            ...
            disabled={saving || deleting || Object.values(uploading).some(Boolean)}
          >
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            ...
            <Button
              type="submit"
              size="lg"
              className="flex-1 sm:px-8 shadow-sm"
              disabled={saving || deleting || Object.values(uploading).some(Boolean)}
            >
