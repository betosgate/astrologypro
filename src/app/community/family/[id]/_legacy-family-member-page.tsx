/**
 * @deprecated Legacy temporary family-member natal chart page.
 *
 * Preserved per tasks/22.04.2026/community-natal-toolkit-rendering
 * master-task directive: "Do not delete the existing temporary
 * community natal/family chart UI during this work."
 *
 * Replaced by the shared HoroscopeToolkitPage in sibling `page.tsx`
 * (Task 03 - "Render Family Member Natal Chart With Shared Horoscope
 * Toolkit").
 *
 * This file keeps its original `"use client"` directive and default
 * export so the legacy implementation remains inspectable and
 * compilable, but it is NOT routed: Next.js only routes the reserved
 * filename `page.tsx`. Do not import from it.
 */
/* eslint-disable */
"use client";
