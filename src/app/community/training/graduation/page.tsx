 ...
 *
 * Server component. Protected by the /community/training layout
...
export default async function GraduationPage() {
  ...
  const graduationPageUrl = `${appUrl}/community/training/graduation`;
          ...
          <CardContent className="py-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Button asChild>
                  <Link href="/community/training/ritual-builder">
