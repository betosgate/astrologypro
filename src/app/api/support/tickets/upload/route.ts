...
export async function POST(req: NextRequest) {
  // Allow any authenticated user (Diviner, Affiliate, Admin, Customer)
  ...
  // Same prefix as admin uploads to keep things consistent in storage
  ...
  if (uploadError) {
    console.error("[support/tickets/upload] storage error:", uploadError.message);
    return NextResponse.json(
