...
export async function GET() {
  ...
  const { data, error } = await supabase
    ...
    .select(
      "id, full_name, date_of_birth, birth_time, birth_city, birth_country, birth_lat, birth_lng, relationship, age_group, natal_chart, natal_status, natal_report_id, natal_report_status, chart_updated_at, notes, created_at, updated_at"
    )
