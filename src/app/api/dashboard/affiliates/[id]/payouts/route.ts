...
// GET /api/dashboard/affiliates/[id]/payouts
export async function GET(
  ...
  let query = admin
    ...
    .select(
      "id, affiliate_id, diviner_id, amount_cents, method, reference, proof_url, notes, paid_at, created_at"
    )
    .eq("affiliate_id", id)
...
// POST /api/dashboard/affiliates/[id]/payouts
...
export async function POST(
  ...
  // Link commission_ids if provided and mark them paid
