/**
 * Monthly Transit Lifecycle States
 *
 * Mirrors: supabase/migrations/20260413000184_monthly_transit_lifecycle.sql
 *
 * Extends monthly_transits with full lifecycle tracking so generation
 * failures are visible to admin ops and not silently lost.
 */
