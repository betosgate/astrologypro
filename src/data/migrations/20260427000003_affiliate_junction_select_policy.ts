// Bundled mirror of supabase/migrations/20260427000003_affiliate_junction_select_policy.sql
...
--   does SELECT FROM diviner_affiliates, RLS returns zero rows. That
--   makes every IN-subquery in the child policies empty, so the
--   affiliate can't see anything anywhere.
--
...
--   already has the matching account_self_select policy, so the chain
--   is unbroken.
--
