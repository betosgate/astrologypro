// Mirror of supabase/migrations/20260430000002_repair_service_template_links.sql
// Used by the admin migration runner UI.

export const MIGRATION_SQL = `-- Repair and harden service -> service_template linkage.
--
-- Context:
