// AUTO-GENERATED bundled mirror of supabase/migrations/20260514000001_ingress_chart_related_insights_rpc.sql
// Used by /api/admin/db/migrate so the deployed function does not need fs.

export const MIGRATION_SQL = `-- Ingress Charts: related insights scoring.
