// Bundled mirror of supabase/migrations/20260421000002_add_general_service_templates.sql
//
...
//
// Purpose: Clone the 19 canonical diviner-specific service templates into a
// parallel general catalog by copying the source rows and only changing the
// public name + slug. Safe to re-run because each insert is guarded by a
// NOT EXISTS check on the cloned slug.
