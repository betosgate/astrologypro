// AUTO-GENERATED bundled mirror of supabase/migrations/20260408000116_training_notes_allow_quiz.sql

export const MIGRATION_SQL = `-- Extend training_notes.entity_type to allow 'quiz'.
--
