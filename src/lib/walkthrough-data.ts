...
export const WALKTHROUGH_SECTIONS: WalkthroughSection[] = [
  {
    ...
    screens: [
      ...
      { name: "overview_v2", label: "System Command Center", description: "Primary entry point for administrative controls and role-based navigation.", group: "Overview" },
      
      // People
      { name: "users", label: "User Directory", description: "Management of all platform accounts and profiles.", group: "People" },
      { name: "diviners_v2", label: "Diviner Directory", description: "Specialized view for practitioner management.", group: "People" },
      ...
      { name: "media_items_v2", label: "Global Asset Library", description: "Centralized media and file management.", group: "Content" },
      ...
      { name: "spiritual_wisdom_v2", label: "Wisdom Library", description: "Curation of esoteric spiritual knowledge.", group: "Content" },
      ...
      { name: "ingress_charts_v2", label: "Ingress Engine", description: "Management of planetary entry charts.", group: "Astrology" },
