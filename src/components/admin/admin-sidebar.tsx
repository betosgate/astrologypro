...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "My Bookings", href: "/admin/my-bookings", icon: CalendarCheck },
      { label: "Calender View", href: "/admin/calendar-view", icon: CalendarCheck },
    ],
  },
  {
    label: "Community",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Ritual Configurations", href: "/admin/rituals", icon: Flame },
    ],
  },
  {
    label: "Reports",
