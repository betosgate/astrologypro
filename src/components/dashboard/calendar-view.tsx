              ...
              <div className="pt-4 border-t">
                ...
                {editingNotes ? (
                  <div className="space-y-2">
                    <Textarea value={notesValue} onChange={(e) => setNotesValue(e.target.value)} rows={5} placeholder="Session notes, instructions, or details for the client…" className="text-sm" />
                  ...
                  <div className="text-sm prose prose-invert max-w-none bg-muted/30 p-4 rounded-lg border overflow-auto max-h-[150px]" dangerouslySetInnerHTML={{ __html: selectedBooking.session_notes }} />
                ) : (
