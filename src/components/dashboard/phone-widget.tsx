...
export default function PhoneWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {state === "idle" && (
        <div className="flex items-center gap-2 rounded-full bg-card border border-primary/20 px-3 py-1.5 shadow-md backdrop-blur">
      ...
      {state === "ringing" && (
        <div className="w-72 rounded-xl border-2 border-primary bg-card p-4 shadow-xl backdrop-blur">
          <div className="mb-3 flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold leading-tight text-foreground">Incoming Call</p>
      ...
      {state === "active" && (
        <div className="w-64 rounded-xl border border-primary/30 bg-card p-4 shadow-xl backdrop-blur">
          <div className="mb-3 flex items-center gap-3">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-primary/10">
              <Phone className="size-5 text-primary" />
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold leading-tight text-foreground">Call in progress</p>
